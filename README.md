...
```
git config --global user.email "patthanapog.pmp@gmail.com"
...
git branch -m main
git remote add origin https://github.com/kemops/kemproject.git
git push -u origin main
git pull
git clone https://github.com/kemops/Export-Clone-Hyper-V.git       //ครั้งแรก
